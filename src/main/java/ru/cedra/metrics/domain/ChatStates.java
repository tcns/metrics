...
public class ChatStates {
    ...
    static {
        ...
        states.put(ASK_TIME_STEP, "В какое время спросить про количество звонков (входящих) и сделок и заработок");
        states.put(REPORT_TIME_STEP, "В какое время выводить показатели");
