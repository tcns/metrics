package ru.cedra.metrics.web.rest;

import ru.cedra.metrics.MetricsApp;
import ru.cedra.metrics.domain.Authority;
import ru.cedra.metrics.domain.User;
import ru.cedra.metrics.repository.AuthorityRepository;
import ru.cedra.metrics.repository.PersistentTokenRepository;
import ru.cedra.metrics.repository.UserRepository;
import ru.cedra.metrics.security.AuthoritiesConstants;
import ru.cedra.metrics.service.MailService;
import ru.cedra.metrics.service.UserService;
import ru.cedra.metrics.service.dto.UserDTO;
import ru.cedra.metrics.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = MetricsApp.class)
